...
// =========== DATA MANIPULATION FUNCTIONS =========== //
    ...
    function drawChart(dataset, len, hei, barColor, mobile){
      ...
      // set scales for bars
      let XScale = d3.scaleBand().rangeRound([margin.right, len - margin.right]).padding(0.1)
      XScale.domain(d3.range(dataset.length))

      let YScale = d3.scaleLinear().range([0, hei])
      ...
      let senators = svg.append("g")
                           .classed("republican-senators", true)
                           .attr("transform", "translate(0,0)");

      let XScaleBottom = d3.scaleBand().rangeRound([margin.right, len - margin.right], 0.10)
      XScaleBottom.domain(dataset.map(function (d) {return d.senator_name;}))
        
      let YScaleLeft = d3.scaleLinear().range([hei, 0])
      YScaleLeft.domain([70, 100])

      let xAxis = d3.axisBottom(XScaleBottom).ticks(XScaleBottom).tickSizeOuter(0)

      let yAxis = d3.axisLeft(YScaleLeft).ticks(8).tickSizeOuter(1)
      ...
      senators.selectAll("rect")
                    ...
                    if(!mobile){
                      d3.select("#tooltip")
                        ...
                        .html("<h4 class =" + "senator-name" + ">" + "---" + " " + "(" + "---" + ")" + "</h4>" + "<hr>"
                          + "<p class = " + "voting-info" + ">" + "Percent Vote With Party: " + "<span class =" + "vote-percent" + ">" + "<strong>" + "---" + "%" + "<strong>" + "</span>" + "</p>" + "<hr>"
                          + "<div class = tooltip-wrapper>" + "<div>" + "<p>" + "---" + "</p>" + "</div>" + "<div>" + "<p class = " + "voting-info" + ">" + "Total Votes: " + "<strong>" + "---" + "</strong>" + "</p>"
                          + "<p class = " + "voting-info" + ">" + "Missed Votes: " + "<strong>" + "---" + "</strong>" + "</p>" + "</div>" + "</div>"
                        )
                    }
                    if(mobile){
                  ...
                  .on("mouseover", function(d){
                    let xPosition = parseFloat(d3.select(this).attr("x")) + XScale.bandwidth();
                    ...
                    if (!mobile){
                      ...
                      d3.select("#tooltip")
                        ...
                        .html("<h4 class =" + "senator-name" + ">" + d.senator_name + " " + "(" + d.state + ")" + "</h4>" + "<hr>"
                          ...
                          + "<div class = tooltip-wrapper>" + "<div class = " + "photo" + ">" + "<img src = " + d.photo_url + ">" + "</div>" + "<div>" + "<p class = " + "voting-info" + ">" + "Total Votes: " + "<strong>" + d.total_votes + "</strong>" + "</p>"
